      ...
      <div className="grid min-h-[85vh] items-center gap-20 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-12 flex flex-wrap gap-5">
            <Link
              href={`/${locale}/gallery`}
              className="rounded-xl bg-stone-900 px-8 py-4 text-white transition hover:bg-stone-700"
            >
              {t.galleryButton}
            </Link>
            ...
            <Link
              href={`/${locale}/artist`}
              className="rounded-xl border border-stone-300 px-8 py-4 transition hover:bg-stone-100"
            >
              {t.aboutButton}
            </Link>
          </div>
